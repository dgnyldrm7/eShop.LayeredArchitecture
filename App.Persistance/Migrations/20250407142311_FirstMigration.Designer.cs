...
namespace App.Persistance.Migrations
{
    ...
    [Migration("20250407142311_FirstMigration")]
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2025, 4, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(4917),
                            PaymentId = 1,
                            ShippingId = 1,
                            Status = 1,
                            TotalAmount = 100.00m,
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            OrderId = 1,
                            PaymentDate = new DateTime(2025, 4, 7, 17, 23, 10, 576, DateTimeKind.Local).AddTicks(5236),
                            PaymentMethod = 0,
                            Status = 5,
                            TransactionId = 1
                        });
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Shipping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeliveryDate = new DateTime(2025, 4, 12, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(5545),
                            OrderId = 1,
                            ShippingDate = new DateTime(2025, 4, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(5545),
                            State = "IL",
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentId = 1,
                            Status = 1,
                            TransactionDate = new DateTime(2025, 4, 7, 17, 23, 10, 576, DateTimeKind.Local).AddTicks(5881)
                        });
                });
            ...
            modelBuilder.Entity("App.Core.Entities.ProductManagment.Answer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(6239),
            ...
            modelBuilder.Entity("App.Core.Entities.ProductManagment.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(6815),
            ...
            modelBuilder.Entity("App.Core.Entities.PromotionManagment.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "COUPON100",
                            DiscountAmount = 100m,
                            EndDate = new DateTime(2025, 5, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(8229),
                            IsActive = true,
                            SellerId = 1,
                            StartDate = new DateTime(2025, 4, 7, 14, 23, 10, 576, DateTimeKind.Utc).AddTicks(8228),
                            UsageLimit = 10,
                            UsedCount = 0
                        });
                });
            ...
            modelBuilder.Entity("App.Core.Entities.UserManagment.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3ed6510a-d37b-413c-a717-452fd0a4084c",
                            CreatedDate = new DateTime(2025, 4, 7, 14, 23, 10, 577, DateTimeKind.Utc).AddTicks(719),
                            ...
                            SecurityStamp = "9e94feed-0dfd-489a-893e-53cf847cceab",
