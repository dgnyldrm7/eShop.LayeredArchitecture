...
namespace App.Persistance.Migrations
{
    ...
    [Migration("20250407142711_addModerator")]
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2025, 4, 7, 14, 27, 11, 44, DateTimeKind.Utc).AddTicks(7966),
                            PaymentId = 1,
                            ShippingId = 1,
                            Status = 1,
                            TotalAmount = 100.00m,
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            OrderId = 1,
                            PaymentDate = new DateTime(2025, 4, 7, 17, 27, 11, 44, DateTimeKind.Local).AddTicks(8161),
                            PaymentMethod = 0,
                            Status = 5,
                            TransactionId = 1
                        });
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Shipping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeliveryDate = new DateTime(2025, 4, 12, 14, 27, 11, 44, DateTimeKind.Utc).AddTicks(8400),
                            OrderId = 1,
                            ShippingDate = new DateTime(2025, 4, 7, 14, 27, 11, 44, DateTimeKind.Utc).AddTicks(8399),
                            State = "IL",
            ...
            modelBuilder.Entity("App.Core.Entities.OrderManagment.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentId = 1,
                            Status = 1,
                            TransactionDate = new DateTime(2025, 4, 7, 17, 27, 11, 44, DateTimeKind.Local).AddTicks(8606)
                        });
                });
            ...
            modelBuilder.Entity("App.Core.Entities.ProductManagment.Answer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 7, 14, 27, 11, 44, DateTimeKind.Utc).AddTicks(8793),
            ...
            modelBuilder.Entity("App.Core.Entities.ProductManagment.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 7, 14, 27, 11, 44, DateTimeKind.Utc).AddTicks(9140),
            ...
            modelBuilder.Entity("App.Core.Entities.PromotionManagment.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "COUPON100",
                            DiscountAmount = 100m,
                            EndDate = new DateTime(2025, 5, 7, 14, 27, 11, 45, DateTimeKind.Utc).AddTicks(238),
                            IsActive = true,
                            SellerId = 1,
                            StartDate = new DateTime(2025, 4, 7, 14, 27, 11, 45, DateTimeKind.Utc).AddTicks(238),
                            UsageLimit = 10,
                            UsedCount = 0
                        });
                });
            ...
            modelBuilder.Entity("App.Core.Entities.UserManagment.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cc7f0088-7f2f-4ac1-b060-ca45eabfec01",
                            CreatedDate = new DateTime(2025, 4, 7, 14, 27, 11, 45, DateTimeKind.Utc).AddTicks(2034),
                            ...
                            SecurityStamp = "d745db4a-93e4-43db-b551-f7218b29afdb",
